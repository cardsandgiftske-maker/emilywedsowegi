              ...
              <div className="space-y-6 my-6 relative z-10">
                ...
                <div className="py-3 border-y border-[#D4A359]/40 my-2 max-w-xs mx-auto">
                  <h1 className="text-lg sm:text-xl font-serif tracking-widest text-[#2B1E1A] font-bold uppercase leading-relaxed">
                    EMILLY &amp; OWEGI&apos;S <br />
                    <span className="text-[#C85A32]">NYOMBO CEREMONY</span>
                  </h1>
                </div>
                ...
                <div className="pt-4 flex flex-col items-center justify-center">
                  <div
                    className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-[#E0683B] via-[#C85A32] to-[#8C3415] border-4 border-[#D4A359] shadow-xl flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 transition-transform"
                  >
                    {/* Inner Wax Seal Rim */}
                    <div className="w-16 h-16 sm:w-19 sm:h-19 rounded-full border border-dashed border-[#F5EFE6]/60 flex items-center justify-center bg-[#A63C20] shadow-inner">
                      <div className="text-center">
                        <span className="block font-serif text-sm sm:text-base font-bold text-[#F5EFE6] tracking-widest">
                          E &amp; O
                        </span>
                        <span className="block text-[8px] text-[#F5EFE6]/80 uppercase tracking-wider font-semibold">
                          SEAL
                        </span>
                      </div>
                    </div>
