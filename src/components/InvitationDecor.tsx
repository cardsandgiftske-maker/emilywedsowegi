...
// Top Left Floral Arrangement with Cream Roses, Terracotta/Orange Florals & Warm Foliage
export const TopLeftFloralSVG: React.FC<{ className?: string }> = ({ className = '' }) => (
  ...
  >
    <g id="foliage">
      {/* Warm Earthy Brown Background Leaves */}
      <path d="M40 180 Q10 140 15 90 Q30 110 50 140 Z" fill="#5C3827" opacity="0.85" />
      <path d="M20 150 Q-10 110 5 60 Q20 80 35 115 Z" fill="#7A4E35" opacity="0.75" />
      <path d="M70 210 Q40 180 30 130 Q55 150 75 180 Z" fill="#3D2316" opacity="0.9" />
      <path d="M15 110 Q-15 80 5 30 Q20 50 28 80 Z" fill="#9C6B4E" opacity="0.7" />
      
      {/* Stems */}
      <path d="M60 210 Q30 140 20 60" stroke="#3D2316" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M110 130 Q80 70 50 10" stroke="#3D2316" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M150 80 Q100 40 40 5" stroke="#3D2316" strokeWidth="2" strokeLinecap="round" />

      {/* Warm Ochre & Beige Leaf Sprays */}
      <ellipse cx="35" cy="110" rx="14" ry="9" transform="rotate(-30 35 110)" fill="#8C5C3D" stroke="#3D2316" strokeWidth="1" />
      <ellipse cx="25" cy="80" rx="12" ry="8" transform="rotate(-40 25 80)" fill="#A8744F" stroke="#3D2316" strokeWidth="1" />
      <ellipse cx="20" cy="50" rx="10" ry="6" transform="rotate(-20 20 50)" fill="#C4916B" stroke="#3D2316" strokeWidth="1" />

      <ellipse cx="85" cy="75" rx="15" ry="10" transform="rotate(-15 85 75)" fill="#7A4E35" stroke="#3D2316" strokeWidth="1" />
      <ellipse cx="65" cy="45" rx="13" ry="8" transform="rotate(-35 65 45)" fill="#8C5C3D" stroke="#3D2316" strokeWidth="1" />
      <ellipse cx="45" cy="20" rx="10" ry="6" transform="rotate(-50 45 20)" fill="#A8744F" stroke="#3D2316" strokeWidth="1" />
    ...
    <g id="cream-rose-1" transform="translate(60, 40)">
      {/* Outer Petals */}
      <path d="M-10 10 C-35 -15 -10 -45 20 -40 C50 -45 70 -15 50 15 C30 40 -10 35 -10 10 Z" fill="#FDF8F2" stroke="#E6D3B8" strokeWidth="1.5" />
    ...
    {/* Terracotta/Orange Daisy */}
    <g id="terracotta-flower" transform="translate(45, 125)">
      {/* Petals radiating */}
      <g fill="#C85A32" stroke="#8A341A" strokeWidth="1">
      ...
      {/* Center Seed Pod */}
      <circle cx="0" cy="0" r="11" fill="#3D2010" stroke="#D4A359" strokeWidth="2" />
      <circle cx="0" cy="0" r="7" fill="#2B1E1A" />
    </g>

    {/* Ivory Baby's Breath */}
    <g fill="#FAF6EE" stroke="#D4A359" strokeWidth="0.5">
...
// Top Right Woven Kiondo/Lilio Basket & Burnt Orange Fabric Swag
export const TopRightBasketAndFabricSVG: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg
    ...
    className={`pointer-events-none ${className}`}
  >
    {/* Draped Burnt Orange and Dark Brown Traditional Cloth */}
    <g id="orange-fabric">
      <path
      ...
      />
      {/* Fabric Fold Lines */}
      <path d="M80 0 Q140 70 240 120" stroke="#3D1D12" strokeWidth="2" opacity="0.6" />
      <path d="M120 0 Q170 60 240 80" stroke="#3D1D12" strokeWidth="1.5" opacity="0.5" />
      <path d="M160 0 Q200 50 240 50" stroke="#2B1E1A" strokeWidth="1.5" opacity="0.5" />
    </g>

    {/* Traditional Woven Winnowing Basket / Kiondo Motif */}
    <g id="woven-basket" transform="translate(155, 75)">
      {/* Outer Rim */}
      <circle cx="0" cy="0" r="58" fill="#FAF6EE" stroke="#D4A359" strokeWidth="4" />
      <circle cx="0" cy="0" r="54" stroke="#3D2316" strokeWidth="2" strokeDasharray="6 3" />
      
      {/* Terracotta/Brown Diamond Tribal Ring */}
      <circle cx="0" cy="0" r="45" fill="#EAD9C6" stroke="#C85A32" strokeWidth="3" />
      ...
      {/* Dark Brown Inner Circle */}
      <circle cx="0" cy="0" r="32" fill="#3D2316" />
      <circle cx="0" cy="0" r="26" stroke="#D4A359" strokeWidth="2.5" strokeDasharray="4 2" />

      {/* Warm Ochre/Gold Center Star Burst */}
      <path
        d="M0 -26 L5 -8 L26 0 L5 8 L0 26 L-5 8 L-26 0 L-5 -8 Z"
        fill="#D4A359"
      />
      <circle cx="0" cy="0" r="7" fill="#C85A32" />
      <circle cx="0" cy="0" r="3" fill="#FAF6EE" />
    </g>
  </svg>
);

// Bottom Left Clay Water Pot, Woven Lid Basket, Small Bowl & Terracotta Draped Cloth
export const BottomLeftClayPotAndDrapeSVG: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg
    ...
    className={`pointer-events-none ${className}`}
  >
    {/* Draped Dark Brown & Terracotta Fabric Base */}
    <g id="draped-fabric-base">
      {/* Dark Brown Fabric Underlayer */}
      <path
        d="M0 120 C50 120 100 160 160 210 C210 250 240 280 280 320 L0 320 Z"
        fill="#3D2316"
        opacity="0.95"
      />
      <path d="M0 120 Q90 190 260 320" stroke="#23130B" strokeWidth="2.5" opacity="0.6" />

      {/* Terracotta/Burnt Orange Fabric Top Swag */}
      <path
      ...
      <path d="M0 210 Q80 260 250 320" stroke="#C85A32" strokeWidth="2" opacity="0.6" />
    ...
    <g id="clay-pot-jug" transform="translate(15, 95)">
      ...
      {/* Pot Mouth Rim */}
      <ellipse cx="55" cy="-2" rx="20" ry="7" fill="#4A1E11" />
      <ellipse cx="55" cy="-3" rx="17" ry="5" fill="#C85A32" />
      <ellipse cx="55" cy="-4" rx="13" ry="3" fill="#2B1007" />

      {/* Neck Tribal Pattern Band */}
      <path d="M42 12 Q55 17 68 12 L67 18 Q55 23 43 18 Z" fill="#2B1007" />
    ...
    <g id="woven-lid-basket" transform="translate(10, 215)">
      ...
      {/* Rounded Lid */}
      <ellipse cx="50" cy="22" rx="50" ry="20" fill="#FAF6EE" stroke="#704712" strokeWidth="2.5" />
      <ellipse cx="50" cy="18" rx="42" ry="15" fill="#C85A32" opacity="0.85" />
      <ellipse cx="50" cy="15" rx="32" ry="11" fill="#3D2316" />
    ...
    <g id="small-clay-cup" transform="translate(100, 245)">
      ...
      <ellipse cx="36" cy="0" rx="30" ry="8" fill="#2B1007" stroke="#4A1E11" strokeWidth="1.5" />
...
// Top Tribal Diamond Emblem SVG - Matches traditional boho geometric symbol in Brown, Orange & Beige/Ivory
export const TopEmblemSVG: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`flex items-center justify-center my-3 ${className}`}>
    ...
    >
      {/* Colors: Terracotta/Orange = #C85A32, Dark Brown = #3D2316, Beige Line = #C4916B */}
      
      {/* Horizontal Divider Lines */}
      <line x1="22" y1="60" x2="110" y2="60" stroke="#A8744F" strokeWidth="1.2" strokeLinecap="round" />
      <circle cx="20" cy="60" r="2" fill="#A8744F" />

      <line x1="210" y1="60" x2="298" y2="60" stroke="#A8744F" strokeWidth="1.2" strokeLinecap="round" />
      <circle cx="300" cy="60" r="2" fill="#A8744F" />

      {/* Left Terracotta Rays & Dots */}
      <path d="M 108 53 L 84 46 C 94 51 98 54 108 55 Z" fill="#C85A32" />
      <circle cx="72" cy="43" r="2.5" fill="#C85A32" />
      
      <path d="M 108 67 L 84 74 C 94 69 98 66 108 65 Z" fill="#C85A32" />
      <circle cx="72" cy="77" r="2.5" fill="#C85A32" />

      {/* Right Terracotta Rays & Dots */}
      <path d="M 212 53 L 236 46 C 226 51 222 54 212 55 Z" fill="#C85A32" />
      <circle cx="248" cy="43" r="2.5" fill="#C85A32" />
      
      <path d="M 212 67 L 236 74 C 226 69 222 66 212 65 Z" fill="#C85A32" />
      <circle cx="248" cy="77" r="2.5" fill="#C85A32" />

      {/* Outer Terracotta Main Diamond */}
      <polygon points="160,26 204,60 160,94 116,60" fill="none" stroke="#C85A32" strokeWidth="2.5" strokeLinejoin="miter" />

      {/* Top Cap Diamond & Connection */}
      <line x1="160" y1="26" x2="160" y2="18" stroke="#C85A32" strokeWidth="2" />
      <polygon points="160,6 168,14 160,22 152,14" fill="#FAF6EE" stroke="#C85A32" strokeWidth="2" strokeLinejoin="miter" />
      <polygon points="160,11 163,14 160,17 157,14" fill="#C85A32" />

      {/* Bottom Cap Diamond & Connection */}
      <line x1="160" y1="94" x2="160" y2="102" stroke="#C85A32" strokeWidth="2" />
      <polygon points="160,98 168,106 160,114 152,106" fill="#FAF6EE" stroke="#C85A32" strokeWidth="2" strokeLinejoin="miter" />
      <polygon points="160,103 163,106 160,109 157,106" fill="#C85A32" />

      {/* Bottom Diagonal Hash Strokes */}
      <line x1="149" y1="96" x2="140" y2="105" stroke="#C85A32" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="171" y1="96" x2="180" y2="105" stroke="#C85A32" strokeWidth="2.5" strokeLinecap="round" />

      {/* Flanking External Diamonds & Accents */}
      {/* Upper Left */}
      <polygon points="126,33 130,37 126,41 122,37" fill="#C85A32" />
      <line x1="135" y1="28" x2="139" y2="24" stroke="#3D2316" strokeWidth="2" strokeLinecap="round" />
      <line x1="139" y1="33" x2="143" y2="29" stroke="#3D2316" strokeWidth="2" strokeLinecap="round" />

      {/* Upper Right */}
      <polygon points="194,33 198,37 194,41 190,37" fill="#C85A32" />
      <line x1="185" y1="28" x2="181" y2="24" stroke="#3D2316" strokeWidth="2" strokeLinecap="round" />
      <line x1="181" y1="33" x2="177" y2="29" stroke="#3D2316" strokeWidth="2" strokeLinecap="round" />

      {/* Lower Left */}
      <polygon points="126,81 130,85 126,89 122,85" fill="#3D2316" />
      <line x1="134" y1="93" x2="141" y2="86" stroke="#C85A32" strokeWidth="2.5" strokeLinecap="round" />

      {/* Lower Right */}
      <polygon points="194,81 198,85 194,89 190,85" fill="#3D2316" />
      <line x1="186" y1="93" x2="179" y2="86" stroke="#C85A32" strokeWidth="2.5" strokeLinecap="round" />

      {/* INNER BROWN & ORANGE MOTIF */}
      <g stroke="#3D2316" fill="none">
        {/* Inner Diamond */}
        <polygon points="160,48 172,60 160,72 148,60" strokeWidth="2.5" strokeLinejoin="miter" />
        <polygon points="160,57 163,60 160,63 157,60" fill="#3D2316" stroke="none" />

        {/* Top Brown Chevron & Trunk */}
        ...
        <circle cx="152" cy="44" r="1.5" fill="#3D2316" stroke="none" />
        <circle cx="168" cy="44" r="1.5" fill="#3D2316" stroke="none" />

        {/* Bottom Brown Chevron & Trunk */}
        ...
        <circle cx="152" cy="76" r="1.5" fill="#3D2316" stroke="none" />
        <circle cx="168" cy="76" r="1.5" fill="#3D2316" stroke="none" />
        ...
        <circle cx="144" cy="54" r="1.5" fill="#3D2316" stroke="none" />
        <circle cx="144" cy="66" r="1.5" fill="#3D2316" stroke="none" />
        <circle cx="176" cy="54" r="1.5" fill="#3D2316" stroke="none" />
        <circle cx="176" cy="66" r="1.5" fill="#3D2316" stroke="none" />
      </g>
    </svg>
  </div>
);

// Vertical Side Geometric Tribal Border Pattern in Brown, Orange & Beige/Ivory
  ...
  >
    <defs>
      <pattern id="ankara-side-pattern" width="32" height="60" patternUnits="userSpaceOnUse">
        ...
        <rect width="32" height="60" fill="#2B1E1A" />

        {/* Beige/Ivory Stippled Dots Texture */}
        ...
        {/* Inner Beige/Ochre Framing Lines */}
        <line x1="2" y1="0" x2="2" y2="60" stroke="#D4A359" strokeWidth="1.2" />
        <line x1="30" y1="0" x2="30" y2="60" stroke="#D4A359" strokeWidth="1.2" />

        {/* Terracotta/Orange Outer Chevron */}
        <path d="M 6 30 L 16 10 L 26 30 L 16 50 Z" fill="#C85A32" stroke="#2B1E1A" strokeWidth="0.8" />

        {/* Deep Warm Ochre / Honey Amber Inner Chevron */}
        <path d="M 6 30 L 16 16 L 26 30 L 16 44 Z" fill="#D4A359" />

        {/* Burnt Orange Core Diamond */}
        <polygon points="16,22 22,30 16,38 10,30" fill="#A8482A" />
        <polygon points="16,25 19,30 16,35 13,30" fill="#FAF6EE" />

        {/* Small Connector Beads */}
        <circle cx="16" cy="4" r="2" fill="#D4A359" />
        <circle cx="16" cy="56" r="2" fill="#D4A359" />
      </pattern>
    </defs>
    ...
    >
      <defs>
        <pattern id="african-banner-pattern" width="80" height="40" patternUnits="userSpaceOnUse">
          ...
          <rect width="80" height="40" fill="#2B1E1A" />
          
          {/* Gold & Terracotta Top/Bottom Borders */}
          <rect y="0" width="80" height="3" fill="#D4A359" />
          <rect y="3" width="80" height="2" fill="#C85A32" />
          <rect y="35" width="80" height="2" fill="#C85A32" />
          <rect y="37" width="80" height="3" fill="#D4A359" />

          {/* Geometric Diamonds */}
          <path d="M 0 20 L 20 6 L 40 20 L 20 34 Z" fill="#C85A32" />
          <path d="M 0 20 L 20 10 L 40 20 L 20 30 Z" fill="#D4A359" />
          <polygon points="20,15 25,20 20,25 15,20" fill="#FAF6EE" />

          <path d="M 40 20 L 60 6 L 80 20 L 60 34 Z" fill="#D4A359" />
          <path d="M 40 20 L 60 10 L 80 20 L 60 30 Z" fill="#C85A32" />
          <polygon points="60,15 65,20 60,25 55,20" fill="#FAF6EE" />
...
export const KikoiBorder: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`w-full overflow-hidden ${className}`}>
    <div className="h-2 w-full flex">
      <div className="h-full w-1/8 bg-[#C85A32]" />
      <div className="h-full w-1/8 bg-[#D4A359]" />
      <div className="h-full w-1/8 bg-[#2B1E1A]" />
      <div className="h-full w-1/8 bg-[#FAF6EE]" />
      <div className="h-full w-1/8 bg-[#C85A32]" />
      <div className="h-full w-1/8 bg-[#D4A359]" />
      <div className="h-full w-1/8 bg-[#2B1E1A]" />
      <div className="h-full w-1/8 bg-[#FAF6EE]" />
...
/* Authentic Cowrie Shell SVG (Symbol of African Prosperity & Dowry) */
export const CowrieShellIcon: React.FC<{ className?: string; size?: number }> = ({ className = "", size = 20 }) => (
  <svg 
    ...
    className={className}
  >
    <ellipse cx="12" cy="12" rx="8" ry="10.5" fill="#FAF6EE" stroke="#D4A359" strokeWidth="1.2" />
    <path d="M12 3.5C10.2 5.8 9.5 9 9.5 12C9.5 15 10.2 18.2 12 20.5C13.8 18.2 14.5 15 14.5 12C14.5 9 13.8 5.8 12 3.5Z" fill="#C85A32" opacity="0.85" />
    <path d="M10 7.5H14M9.5 9.8H14.5M9.3 12H14.7M9.5 14.2H14.5M10 16.5H14" stroke="#FAF6EE" strokeWidth="0.9" strokeLinecap="round" />
    <ellipse cx="12" cy="12" rx="1.2" ry="8.5" fill="#2B1E1A" opacity="0.25" />
  </svg>
);

/* Intricate African Beaded Marriage Collar Arch */
export const AfricanBeadedCollar: React.FC<{ className?: string }> = ({ className = "" }) => (
  ...
  >
    ...
    <path d="M 30 18 L 40 34 L 50 18 L 60 36 L 70 20 L 80 40 L 90 22 L 100 42 L 110 24 L 120 44 L 130 24 L 140 45 L 150 25 L 160 46 L 170 25 L 180 45 L 190 24 L 200 44 L 210 24 L 220 42 L 230 22 L 240 40 L 250 20 L 260 36 L 270 18 L 280 34 L 290 18" 
      stroke="#C85A32" strokeWidth="2" fill="none" strokeLinejoin="round" />
      
    {/* Dark Brown Arc */}
    <path d="M 35 25 C 105 80, 215 80, 285 25" stroke="#2B1E1A" strokeWidth="3" />
    
    {/* Beaded Ring Dots (Terracotta, Ochre Gold, Dark Brown, Ivory) */}
    {[
      { cx: 50, cy: 30, color: "#D4A359" },
      { cx: 70, cy: 39, color: "#C85A32" },
      { cx: 90, cy: 47, color: "#2B1E1A" },
      { cx: 110, cy: 53, color: "#FAF6EE" },
      { cx: 130, cy: 57, color: "#D4A359" },
      { cx: 150, cy: 59, color: "#C85A32" },
      { cx: 160, cy: 60, color: "#D4A359" },
      { cx: 170, cy: 59, color: "#C85A32" },
      { cx: 190, cy: 57, color: "#D4A359" },
      { cx: 210, cy: 53, color: "#FAF6EE" },
      { cx: 230, cy: 47, color: "#2B1E1A" },
      { cx: 250, cy: 39, color: "#C85A32" },
      { cx: 270, cy: 30, color: "#D4A359" },
    ].map((bead, i) => (
      <circle key={i} cx={bead.cx} cy={bead.cy} r="3.5" fill={bead.color} stroke="#2B1E1A" strokeWidth="0.5" />
    ))}

    {/* Center Hanging Cowrie Shell Pendant */}
    <g transform="translate(151, 56)">
      <ellipse cx="9" cy="11" rx="6.5" ry="9" fill="#FAF6EE" stroke="#D4A359" strokeWidth="1.2" />
      <path d="M 9 4 C 7.5 6.5, 7 9.5, 7 11 C 7 12.5, 7.5 15.5, 9 18 C 10.5 15.5, 11 12.5, 11 11 C 11 9.5, 10.5 6.5, 9 4 Z" fill="#C85A32" opacity="0.85" />
    </g>
  </svg>
);

/* Floral Rosette Bow Emblem */
export const FloralRosetteBowSVG: React.FC<{ className?: string; size?: number }> = ({ className = "", size = 48 }) => (
  ...
  >
    {/* Tied Traditional Fabric Bow Ribbons (Ochre & Burnt Orange) */}
    <g id="ribbon-bow">
      {/* Left Loop */}
      <path d="M 28 32 C 10 24, 2 34, 12 42 C 22 48, 28 36, 28 32 Z" fill="#D4A359" stroke="#2B1E1A" strokeWidth="1" />
      <path d="M 26 33 C 14 28, 8 35, 15 41 C 22 45, 26 36, 26 33 Z" fill="#C85A32" />
      {/* Right Loop */}
      <path d="M 32 32 C 50 24, 58 34, 48 42 C 38 48, 32 36, 32 32 Z" fill="#D4A359" stroke="#2B1E1A" strokeWidth="1" />
      <path d="M 34 33 C 46 28, 52 35, 45 41 C 38 45, 34 36, 34 33 Z" fill="#C85A32" />
      
      {/* Hanging Ribbon Tails */}
      <path d="M 26 35 L 16 56 L 24 52 L 29 38 Z" fill="#A8482A" stroke="#2B1E1A" strokeWidth="0.8" />
      <path d="M 34 35 L 44 56 L 36 52 L 31 38 Z" fill="#A8482A" stroke="#2B1E1A" strokeWidth="0.8" />
    </g>
    ...
    <g id="ivory-rosette" transform="translate(30, 26)">
      ...
      {/* Golden Center Bead */}
      <circle cx="0" cy="0" r="4.5" fill="#D4A359" stroke="#2B1E1A" strokeWidth="1" />
      <circle cx="0" cy="0" r="2.5" fill="#FAF6EE" />
      <circle cx="0" cy="0" r="1" fill="#3D2316" />
    </g>
  </svg>
);

/* 8-Pointed Gold Star Divider */
export const EightPointStarDivider: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`flex items-center justify-center gap-3 my-2.5 ${className}`}>
    <div className="h-[1px] w-16 sm:w-24 bg-gradient-to-r from-transparent via-[#D4A359] to-[#C85A32]" />
    
    {/* Gold 8-Point Star Emblem */}
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="#D4A359" stroke="#8C5C3D" strokeWidth="1" />
      <path d="M12 6L13.5 10.5L18 12L13.5 13.5L12 18L10.5 13.5L6 12L10.5 10.5L12 6Z" fill="#FAF6EE" />
      <circle cx="12" cy="12" r="2" fill="#3D2316" />
    </svg>

    <div className="h-[1px] w-16 sm:w-24 bg-gradient-to-l from-transparent via-[#D4A359] to-[#C85A32]" />
  </div>
);

/* Rich African Ankara Wax Pattern Banner (Dark Brown, Burnt Orange, Ochre & Ivory Dots) */
    ...
    >
      <defs>
        <pattern id="ankara-menu-pattern" width="100" height="44" patternUnits="userSpaceOnUse">
          {/* Dark Brown Base with Ivory Dots */}
          <rect width="100" height="44" fill="#2B1E1A" />
          
          {/* Stippled Ivory Dot Texture */}
          <g fill="#FAF6EE" opacity="0.45">
          ...
          {/* Top and Bottom Ochre Rails */}
          <rect y="0" width="100" height="3" fill="#D4A359" />
          <rect y="41" width="100" height="3" fill="#D4A359" />

          {/* Outer Terracotta Chevron */}
          <path d="M 0 22 L 25 4 L 50 22 L 25 40 Z" fill="#C85A32" stroke="#2B1E1A" strokeWidth="1" />
          {/* Inner Ochre Gold Chevron */}
          <path d="M 0 22 L 25 9 L 50 22 L 25 35 Z" fill="#D4A359" />
          {/* Inner Burnt Orange Diamond Core */}
          <polygon points="25,14 33,22 25,30 17,22" fill="#A8482A" />
          <polygon points="25,17 29,22 25,27 21,22" fill="#FAF6EE" />

          {/* Second Repeated Chevron Pair */}
          <path d="M 50 22 L 75 4 L 100 22 L 75 40 Z" fill="#C85A32" stroke="#2B1E1A" strokeWidth="1" />
          <path d="M 50 22 L 75 9 L 100 22 L 75 35 Z" fill="#D4A359" />
          <polygon points="75,14 83,22 75,30 67,22" fill="#A8482A" />
...
/* African Geometric Watermark Pattern Background */
export const AfricanGeometricWatermark: React.FC<{ className?: string }> = ({ className = "" }) => (
  <svg 
    className={`absolute inset-0 w-full h-full pointer-events-none opacity-[0.05] ${className}`}
    xmlns="http://www.w3.org/2000/svg"
  >
    <defs>
      <pattern id="african-watermark-pattern" width="60" height="60" patternUnits="userSpaceOnUse">
        {/* Chevron Grid */}
        <path d="M0 30 L15 15 L30 30 L45 15 L60 30" stroke="#3D2316" strokeWidth="1.5" fill="none" />
        <path d="M0 45 L15 30 L30 45 L45 30 L60 45" stroke="#C85A32" strokeWidth="1.5" fill="none" />
        {/* Diamond Accents */}
        <polygon points="30,5 35,10 30,15 25,10" fill="#D4A359" />
        <polygon points="30,35 35,40 30,45 25,40" fill="#C85A32" />
        {/* Cross hatch lines */}
        <line x1="10" y1="50" x2="20" y2="60" stroke="#3D2316" strokeWidth="1" />
        <line x1="40" y1="50" x2="50" y2="60" stroke="#3D2316" strokeWidth="1" />
      </pattern>
    </defs>
...
export const TribalCornerBracket: React.FC<{ position: 'tl' | 'tr' | 'bl' | 'br'; className?: string }> = ({ position, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M 6 34 V 12 C 6 8.7 8.7 6 12 6 H 34" stroke="#C85A32" strokeWidth="1.5" strokeLinecap="round" opacity="0.8" />
      {/* Inner African Chevron Motif */}
      <path d="M 8 26 L 16 18 L 8 10" stroke="#C85A32" strokeWidth="2" fill="none" />
      <path d="M 10 8 L 18 16 L 26 8" stroke="#3D2316" strokeWidth="2" fill="none" />
      <circle cx="7" cy="7" r="3" fill="#D4A359" />
      <polygon points="18,18 22,14 26,18 22,22" fill="#C85A32" />
    </svg>
  );
};
    ...
    >
      <defs>
        <pattern id="tribal-end-to-end-line" width="60" height="24" patternUnits="userSpaceOnUse">
          {/* Dark Brown Base Line */}
          <rect width="60" height="24" fill="#2B1E1A" />
          
          {/* Top & Bottom Ochre Rails */}
          <rect y="0" width="60" height="2" fill="#D4A359" />
          <rect y="22" width="60" height="2" fill="#D4A359" />
          
          {/* Chevron & Diamond Geometric Motifs */}
          <polygon points="0,12 10,2 20,12 10,22" fill="#D4A359" />
          <polygon points="10,12 15,7 20,12 15,17" fill="#C85A32" />
          <polygon points="15,12 17.5,9.5 20,12 17.5,14.5" fill="#A8482A" />

          <polygon points="20,12 30,2 40,12 30,22" fill="#C85A32" />
          <polygon points="30,12 35,7 40,12 35,17" fill="#D4A359" />
          <polygon points="35,12 37.5,9.5 40,12 37.5,14.5" fill="#FAF6EE" />

          <polygon points="40,12 50,2 60,12 50,22" fill="#A8482A" />
          <polygon points="50,12 55,7 60,12 55,17" fill="#C85A32" />
          <polygon points="55,12 57.5,9.5 60,12 57.5,14.5" fill="#D4A359" />
...
/* Overlapping African Woven Baskets Motif */
export const UploadedBasketMotifsSVG: React.FC<{ className?: string }> = ({ className = "" }) => (
  ...
  >
    {/* Secondary Top-Right Woven Basket */}
    <g id="secondary-basket" transform="translate(160, 60)">
      <circle cx="0" cy="0" r="58" fill="#D4A359" stroke="#7A3E26" strokeWidth="3" />
      <circle cx="0" cy="0" r="52" fill="#3D2316" />
      <g fill="#D4A359">
        <polygon points="0,-52 8,-35 -8,-35" />
        <polygon points="0,52 8,35 -8,35" />
        <polygon points="-52,0 -35,8 -35,-8" />
        <polygon points="52,0 35,8 35,-8" />
        <polygon points="-36,-36 -20,-28 -28,-20" fill="#C85A32" />
        <polygon points="36,-36 20,-28 28,-20" fill="#C85A32" />
        <polygon points="-36,36 -20,28 -28,20" fill="#C85A32" />
        <polygon points="36,36 20,28 28,20" fill="#C85A32" />
      </g>
      <circle cx="0" cy="0" r="32" fill="#C85A32" stroke="#D4A359" strokeWidth="2" />
      <circle cx="0" cy="0" r="20" fill="#D4A359" stroke="#3D2316" strokeWidth="2" />
      <circle cx="0" cy="0" r="10" fill="#2B1E1A" />
      <circle cx="0" cy="0" r="4" fill="#FAF6EE" />
    </g>

    {/* Primary Foreground Woven Basket */}
    <g id="primary-basket" transform="translate(85, 85)">
      <circle cx="0" cy="0" r="82" fill="#5C2415" stroke="#2B1E1A" strokeWidth="4" />
      <circle cx="0" cy="0" r="76" fill="#C85A32" />
      <path 
        ...
        strokeWidth="1.5"
      />
      <circle cx="0" cy="0" r="46" fill="#A8482A" stroke="#D4A359" strokeWidth="2" />
      <circle cx="0" cy="0" r="34" fill="#FAF6EE" stroke="#5C2415" strokeWidth="2" />
      <circle cx="0" cy="0" r="24" stroke="#D4A359" strokeWidth="1.5" strokeDasharray="3 2" />
      <circle cx="0" cy="0" r="16" stroke="#D4A359" strokeWidth="1.5" strokeDasharray="3 2" />
      <circle cx="0" cy="0" r="8" stroke="#5C2415" strokeWidth="1.5" />
      <circle cx="0" cy="0" r="3" fill="#2B1E1A" />
    </g>
  </svg>
);

/* Vertical Geometric Ribbon Pattern */
    ...
    <defs>
      <pattern id="vertical-tribal-ribbon-pattern" width="36" height="120" patternUnits="userSpaceOnUse">
        ...
        <g fill="#2B1E1A" stroke="#2B1E1A">
          ...
          <line x1="7" y1="38" x2="29" y2="38" stroke="#2B1E1A" strokeWidth="1.5" />

          <line x1="10" y1="42" x2="10" y2="52" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="14" y1="42" x2="14" y2="52" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="18" y1="42" x2="18" y2="52" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="22" y1="42" x2="22" y2="52" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="26" y1="42" x2="26" y2="52" stroke="#2B1E1A" strokeWidth="1.5" />

          <line x1="7" y1="56" x2="29" y2="56" stroke="#2B1E1A" strokeWidth="1.5" />

          <text x="18" y="68" fontSize="10" fontFamily="sans-serif" textAnchor="middle" fontWeight="bold" fill="#2B1E1A" stroke="none">
            X • X
          </text>
          <text x="18" y="77" fontSize="10" fontFamily="sans-serif" textAnchor="middle" fontWeight="bold" fill="#2B1E1A" stroke="none">
            • X •
          </text>

          <line x1="7" y1="82" x2="29" y2="82" stroke="#2B1E1A" strokeWidth="1.5" />
          ...
          <line x1="7" y1="116" x2="29" y2="116" stroke="#2B1E1A" strokeWidth="1.5" />
        </g>
      </pattern>
    </defs>
...
/* Horizontal Geometric Ribbon Pattern */
    ...
    <defs>
      <pattern id="horizontal-tribal-ribbon-pattern" width="120" height="36" patternUnits="userSpaceOnUse">
        ...
        <g fill="#2B1E1A" stroke="#2B1E1A">
          ...
          <line x1="38" y1="7" x2="38" y2="29" stroke="#2B1E1A" strokeWidth="1.5" />

          <line x1="42" y1="10" x2="52" y2="10" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="42" y1="14" x2="52" y2="14" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="42" y1="18" x2="52" y2="18" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="42" y1="22" x2="52" y2="22" stroke="#2B1E1A" strokeWidth="1.5" />
          <line x1="42" y1="26" x2="52" y2="26" stroke="#2B1E1A" strokeWidth="1.5" />

          <line x1="56" y1="7" x2="56" y2="29" stroke="#2B1E1A" strokeWidth="1.5" />

          <text x="70" y="22" fontSize="10" fontFamily="sans-serif" textAnchor="middle" fontWeight="bold" fill="#2B1E1A" stroke="none">
            X • X
          </text>

          <line x1="82" y1="7" x2="82" y2="29" stroke="#2B1E1A" strokeWidth="1.5" />

          <polygon points="86,8 86,28 98,18" />
          <polygon points="102,11 102,25 112,18" />

          <line x1="116" y1="7" x2="116" y2="29" stroke="#2B1E1A" strokeWidth="1.5" />
        </g>
      </pattern>
    </defs>
...
/* Tribal Diamond Geometric Symbol (Matching Traditional Emblem in Brown, Orange, Beige) */
export const UploadedTribalDiamondSymbolSVG: React.FC<{ className?: string; size?: number }> = ({ 
  ...
  return (
    ...
    >
      ...
      <g stroke="#A8744F" strokeWidth="1">
        <line x1="12" y1="75" x2="72" y2="75" />
        <line x1="168" y1="75" x2="228" y2="75" />
      </g>
      <circle cx="12" cy="75" r="1.5" fill="#A8744F" />
      <circle cx="228" cy="75" r="1.5" fill="#A8744F" />
      ...
      {/* Inner Dark Brown Geometric Pattern */}
      <g fill="#3D2316" stroke="#3D2316">
        {/* Central Inner Brown Diamond */}
        <polygon 
      ...
      <g fill="#C85A32">
        ...
        <line x1="98" y1="36" x2="102" y2="42" stroke="#C85A32" strokeWidth="2" strokeLinecap="round" />
        <line x1="142" y1="36" x2="138" y2="42" stroke="#C85A32" strokeWidth="2" strokeLinecap="round" />
        <line x1="98" y1="114" x2="102" y2="108" stroke="#C85A32" strokeWidth="2" strokeLinecap="round" />
        <line x1="142" y1="114" x2="138" y2="108" stroke="#C85A32" strokeWidth="2" strokeLinecap="round" />
      </g>
    </svg>
  );
};
...
export const TribalDividerWithShells: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`flex items-center justify-center gap-2 sm:gap-3 my-2.5 ${className}`}>
    ...
    <div className="flex-1 flex items-center justify-end h-[2px]">
      <div className="w-full h-[1.5px] bg-gradient-to-r from-transparent via-[#D4A359] to-[#C85A32]" />
      <div className="w-2 h-2 rotate-45 bg-[#C85A32]" />
    </div>
    ...
    <div className="flex items-center gap-1.5 px-1">
      <div className="w-2.5 h-2.5 rotate-45 bg-[#D4A359] border border-[#2B1E1A]" />
      <div className="w-4 h-4 rotate-45 bg-[#2B1E1A] border border-[#D4A359] flex items-center justify-center">
        <div className="w-1.5 h-1.5 bg-[#C85A32]" />
      </div>
      <div className="w-2.5 h-2.5 rotate-45 bg-[#D4A359] border border-[#2B1E1A]" />
    </div>
    ...
    <div className="flex-1 flex items-center justify-start h-[2px]">
      <div className="w-2 h-2 rotate-45 bg-[#C85A32]" />
      <div className="w-full h-[1.5px] bg-gradient-to-l from-transparent via-[#D4A359] to-[#C85A32]" />
    </div>
  </div>
);
