      ...
      <section id="venue" className="max-w-4xl mx-auto text-center space-y-6">
        ...
        <div className="bg-[#2B1E1A] rounded-2xl p-2 border-2 border-[#D4A359] shadow-lg relative overflow-hidden">
          <div className="relative w-full h-[320px] sm:h-[400px] rounded-xl overflow-hidden bg-gray-100">
            ...
            <div className="absolute bottom-3 left-3 right-3 bg-[#2B1E1A]/95 backdrop-blur-md text-[#F5EFE6] p-3.5 rounded-xl border border-[#D4A359] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs sm:text-sm shadow-xl">
              <div className="flex items-center gap-2 text-left">
                <MapPin className="w-4 h-4 text-[#C85A32] shrink-0" />
                <div>
                  <span className="font-serif font-bold block text-sm">Gombe Komollo</span>
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#D4A359] hover:bg-[#e2b46c] text-[#2B1E1A] font-bold transition-all shadow-md active:scale-95 text-xs uppercase tracking-wider shrink-0"
              >
                <Navigation className="w-3.5 h-3.5 text-[#2B1E1A]" />
                <span>Open in Google Maps</span>
                <ExternalLink className="w-3 h-3 text-[#2B1E1A]" />
              </a>
            </div>
          </div>
        </div>

        {/* Prominent Direct Directions Button */}
        <div className="pt-2">
          <a
            href={googleMapsSearchUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-full bg-[#C85A32] hover:bg-[#b54a24] text-white font-sans font-bold text-sm uppercase tracking-wider shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 active:translate-y-0 active:scale-95 border-2 border-[#D4A359]"
          >
            <Navigation className="w-4 h-4 text-[#FAF6EE] animate-pulse" />
            <span>Open Directions on Google Maps</span>
            <ExternalLink className="w-4 h-4 text-[#FAF6EE]/80" />
          </a>
        </div>
